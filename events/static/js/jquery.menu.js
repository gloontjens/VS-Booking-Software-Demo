var MainMenu = function () {
    ...
    this.init = function (p) {
        ...
        $('ul.main-menu > li').click(function (event) {
            ...
            $('.fab5', this).toggleClass('fab-color');
            $('.fab3', this).toggleClass('fab-border');
        ...
        $('ul.main-menu > li > ul li').click(function (event) {
            ...
            if ($(this).has( "ul" ).length > 0) {
                ...
                $('.fab5', this).removeClass('fab-color');
                $('.fab3', this).removeClass('fab-border');
            	closeMainMenu();
            }
        });
...
//                 left: el.width() + paddingLeft + 'px',
        ...
        $(document).bind('click', function (event) {
            ...
            if (!target.hasClass('active-menu') && !target.parents().hasClass('active-menu')) {
                $('.fab5').removeClass('fab-color');
                $('.fab3').removeClass('fab-border');
                closeMainMenu();
            }
        });
    }
